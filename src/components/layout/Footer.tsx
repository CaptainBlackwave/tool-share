        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl tracking-wide" style={{ fontFamily: 'var(--font-bebas), sans-serif' }}>
                TOOLSHARE
              </span>
            </div>
            <p className="text-[#9ca3af] text-sm">
              Rent tools from your neighbors. Save money. Complete your projects.
            </p>
          </div>

          <div>
            <h4 className="font-medium mb-4 text-[#e85d04]" style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: '1.25rem' }}>
              COMPANY
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="flex-1 px-3 py-2 bg-[#2a2a2a] border border-[#404040] rounded text-sm text-white placeholder-[#6b6b6b] focus:outline-none focus:border-[#e85d04]"
              />
              <button className="px-4 py-2 bg-[#e85d04] text-white text-sm font-medium rounded hover:bg-[#d14f00] transition-colors">
                Join
              </button>
            </div>
          </div>
